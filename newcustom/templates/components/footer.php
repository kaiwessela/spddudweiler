<footer>
	<div class="content">
		<div>
			...
			<ul class="link-list">
				...
				<li><a href="<?= $server->url ?>/aktuelles">Aktuelles</a></li>
				<li><a href="<?= $server->url ?>/ueber-uns">Über uns</a></li>
				<li><a href="<?= $server->url ?>/wir-vor-ort">Wir vor Ort</a></li>
				<li><a href="<?= $server->url ?>/mitmachen">Mitmachen</a></li>
			</ul>
			<br>
			<ul class="link-list">
				<li><a href="<?= $server->url ?>/impressum">Impressum</a></li>
				<li><a href="<?= $server->url ?>/datenschutz">Datenschutzerklärung</a></li>
			</ul>
		</div>
		<div>
			<h2>Kontakt</h2>
	...
	<img class="logo" src="<?= $server->url ?>/resources/images/static/Logo_SPD_Dudweiler_rot.svg" alt="">
</footer>
